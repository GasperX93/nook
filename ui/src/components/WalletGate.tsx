 ...
 * (spike/swarm-id-only: identity comes from Swarm ID, not a wallet; the
 * component keeps its name to avoid touching every import).
 */
...
export default function WalletGate({
  ...
  const { deriveViaSwarmId, deriving } = useDerivedKey()
  ...
  return (
    ...
    >
      ...
      <Button onClick={async () => deriveViaSwarmId()} disabled={deriving} size="sm">
