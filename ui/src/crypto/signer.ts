 ...
 * (spike/swarm-id-only). The rest of the string is the 32-byte app material
 * from `deriveAppSecret`, hex-encoded.
 */
...
/**
 * Create a NookSigner from a 32-byte Swarm ID app secret (spike/swarm-id-only).
